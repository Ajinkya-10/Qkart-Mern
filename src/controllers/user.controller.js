...
// DONE: CRIO_TASK_MODULE_UNDERSTANDING_BASICS - Implement getUser() function
...
const getUser = catchAsync(async (req, res) => {
  ...
  if(data){
    if(data.email !== req.user.email){
      throw new ApiError(httpStatus.FORBIDDEN, "User not authorized to access this resources");
    } else {
      if(req.query.q === "address"){
